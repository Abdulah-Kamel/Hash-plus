...
const CourseCard = ({ course }) => {
  return (
    <Card className="w-full max-w-sm flex flex-col overflow-hidden rounded-2xl pt-0 gap-2">
      ...
      <CardHeader className="flex-grow">
        ...
        <div className="mt-4 flex items-center gap-2">
          <Image className="rounded-full bg-gray-100" src={courseProfile} alt="Instructor avatar" width={40} height={40} />
