    ...
    return (
      <Dialog dir={"rtl"}>
        <DialogTrigger asChild>
          <button className="text-secondary cursor-pointer flex items-center gap-1.5 px-2 sm:px-3 py-1.5 border border-secondary hover:bg-secondary/10 rounded-lg duration-200">
            <Sparkle />
            اسال ال AI
          </button>
        </DialogTrigger>
        <DialogContent
          className="sm:max-w-[80%] w-full rounded-3xl p-0 flex flex-col"
          showCloseButton={false}
        >
          <DialogHeader className="border-b border-gray-200 w-full p-4 flex flex-row justify-between items-center">
          ...
          <div className="grid grid-cols-4">
              ...
              <div className="flex-grow p-6 space-y-6 overflow-y-auto max-lg:max-h-[500px]">
                <div className="flex items-start gap-3 justify-start">
                  ...
                  <div className="bg-gray-100 p-3 rounded-lg max-w-2xl">
                    <p className="text-sm">
                      Hello! I'm your personal AI Assistant Slothpilot.
                    </p>
                ...
                <div className="flex items-start gap-3 justify-end">
                  <div className="bg-primary text-white p-3 rounded-lg max-w-md">
                    ...
                    <span className="text-xs text-primary-foreground/70 block text-left mt-1">
                      11:25 ✓
                    </span>
                  </div>
                  <Avatar className="w-10 h-10">
                ...
                <div className="flex items-start gap-3 justify-start">
                  ...
                  <div className="bg-gray-100 p-4 rounded-lg max-w-2xl space-y-2">
                    <p className="text-sm">
                      Do Androis Dream of Electric Sheep? is a 1968 dystopian
                      science fiction novel by American writer Philip K. Dick.
                      Set in a post-apocalyptic San Francisco, the story unfolds
                      after a devastating global war.
                    </p>
                    <ol className="list-decimal list-inside text-sm space-y-1">
                      <li>
                        <b>Androis and Humans</b>: The novel explores the uneasy
                        coexistence of humans and androids. Androids,
                        manufactured on Mars, rebel, kill their owners, and
                        escape to Earth, where they hope to remain undetected.
                      </li>
                      <li>
                        <b>Empathy and Identity</b>: To distinguish androids
                        from humans, the Voight-Kampff test measures emotional
                        responses. Androids lack empathy, making them vulnerable
                        to detection.
                      </li>
                      <li>
                        <b>Status Symbols</b>: Owning real animals is a status
                        symbol due to mass extinctions. Poor people resort to
                        realistic electric robotic imitations of live animals,
                        concealing their true nature from neighbors.
                      </li>
                    </ol>
                    <span className="text-xs text-muted-foreground block text-left mt-1">
                      12:25 ✓
            ...
            <div className="max-lg:hidden col-span-1 border-l border-gray-200 p-4 flex flex-col">
              ...
              <div className="flex-grow space-y-2 overflow-y-auto">
                <button className="w-full text-right p-3 rounded-lg bg-gray-100 font-semibold">
                  تلخيص المحاضرة
                </button>
                <button className="w-full text-right p-3 rounded-lg hover:bg-gray-100">
                  ما الذي سوف تستفيد به من الدورة
                </button>
                <button className="w-full text-right p-3 rounded-lg hover:bg-gray-100">
                  ما الذي سوف تستفيد به من الدورة
                </button>
