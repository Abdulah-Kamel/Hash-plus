...
import { handleEmailConfirm } from "@/components/auth/otp/otpActions";
    ...
    <>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <Button
            type="submit"
            className="w-full px-5 py-2 sm:py-6 rounded-lg max-sm:text-xs cursor-pointer"
            disabled={loading}
          >
            {loading ? <Spinner className="size-8" /> : "تاكيد"}
          </Button>
        </form>
      </Form>
    </>
