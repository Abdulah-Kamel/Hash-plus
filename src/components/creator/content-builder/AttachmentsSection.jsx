  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-right">
        <p className="text-[15px] font-medium text-gray-400 leading-8 max-w-3xl ml-auto" dir="rtl">
          يُفَضِّل المتعلمون من جميع مستويات إجادة اللغة الترجمة المصاحبة بشدة، إذ تُساعد على متابعة المحتوى وفهمه وحفظه. كما يُعَدّ وجود الترجمة المصاحبة أمرًا بالغ الأهمية لضمان سهولة وصول الصم أو ضعاف السمع إلى المحتوى. تعرّف على المزيد.
        </p>
      </div>
      ...
      <div className="space-y-3 pt-4 border-t border-gray-100">
        ...
        >
          ...
          <span className="text-[#5b73e8] font-medium text-sm">أرفق صورة الدورة هنا</span>
          <input 
            type="file" 
            ref={fileInputRef} 
            className="hidden" 
      ...
      {attachments.length > 0 && (
        <div className="space-y-3 pt-6">
          {attachments.map((file) => (
            <div key={file.id} className="border border-gray-100 rounded-xl p-3 flex items-center justify-between bg-white shadow-sm transition-all hover:border-gray-200">
              <button 
                type="button"
