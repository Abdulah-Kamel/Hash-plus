  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-500 text-right leading-relaxed">
        ابدأ بإعداد دورتك بإنشاء أقسام ومحاضرات وأنشطة تدريبية (اختبارات قصيرة،
        تمارين برمجة، وواجبات). استخدم مخطط الدورة لتنظيم محتوك وتصنيف أقسامك
        ومحاضراتك بوضوح. إذا كنت تنوي تقديم دورتك مجاناً فيجب ألا تتجاوز مدة
        الفيديو ساعتين.
      </p>
