              ...
              <div className="lg:col-span-3 space-y-6 max-lg:order-2">
                ...
                <div className="space-y-8">
                  ...
                  <div className="text-center pt-8">
                    <Button
                      variant="outline"
                      className="rounded-full px-8 py-3 border-secondary text-secondary hover:bg-secondary hover:text-white w-full"
                    >
                      عرض المزيد
                    </Button>
                  </div>
              ...
              <div className="lg:col-span-1 -translate-y-1/6 max-lg:order-1">
                <Card className="bg-white rounded-3xl shadow-lg p-6">
                  <CardContent className="text-center space-y-4">
                    ...
                    <Button
                      variant="outline"
                      className="w-full rounded-full border-2 border-primary transition-colors text-primary group hover:bg-primary hover:text-white"
                    >
                      متابعة
